...
AC_DEFUN([W2_CONFIGURE_W2TOOLS],[
  ...
  DISPLAY_3rdPARTY_LIBS="${DISPLAY_3rdPARTY_LIBS} ${PNG_LIBS} ${QTLIB} ${FREETYPE_LIBS} ${GL_LIBS}"
  DISPLAY_3rdPARTY_INCLUDES="${DISPLAY_3rdPARTY_INCLUDES} ${PNG_CFLAGS} ${GL_CFLAGS} ${XPM_CFLAGS} ${QTINCLUDE} ${FREETYPE_CFLAGS}"
